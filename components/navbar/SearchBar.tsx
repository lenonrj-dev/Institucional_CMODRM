...
import { searchItems, COLLECTION_META, type AcervoItem, type CollectionKey } from "../../app/acervo/api";

const ICON: Partial<Record<CollectionKey, LucideIcon>> = {
  documentos: FileText,
  boletins: Newspaper,
  fotos: Images,
  entrevistas: Mic2,
...
export default function SearchBar({
  ...
  const results = useMemo<AcervoItem[]>(() => (deb ? searchItems(deb) : []), [deb]);
