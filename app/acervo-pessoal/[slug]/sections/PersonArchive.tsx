...
type PersonArchiveProps = { person: { name: string; occupation: string; summary: string; portrait?: string } };
...
export default function PersonArchive({ person }: PersonArchiveProps) {
  /* —— busca + filtros —— */
