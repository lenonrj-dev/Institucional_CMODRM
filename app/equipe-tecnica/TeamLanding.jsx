...
/* ========= subcomponents ========= */
const ProfileCard = memo(function ProfileCard({ m }) {
  return (
    <motion.article
...
const ProfileRow = memo(function ProfileRow({ m }) {
  return (
    <motion.article
...
function OrgAccordion({ groups }) {
  const [open, setOpen] = useState(() => new Set(["Coordenação", "Desenvolvimento"]));
